...
define('utils/aopproxy', ['utils', 'utils/executionevent'], function (utils, execEvent) {
        ...
        function MethodNameNotExistOrReserved(message) {
            Error.call(this);
        ...
        MethodNameNotExistOrReserved.prototype = new Error();
        MethodNameNotExistOrReserved.prototype.constructor = MethodNameNotExistOrReserved;
        ...
        function AOPProxy(object) {
            ...
            this.aspectBefore = function (method_name, aspect) {
                if (!isAspectableMethod(this, method_name)) {
                    throw new MethodNameNotExistOrReserved();
                }
